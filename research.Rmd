...
*Note: As students and postdocs are starting in Spring 2027, this section primarily reflects Dr. Berigan's past work at other institutions. More details on our current research projects will be added shortly!*
...
Identifying features which limit the population growth of a species is a crucial aspect of wildlife management. During my postdoc at [K-State](https://www.k-state.edu), I focused on identifying limiting factors for lesser prairie-chicken occupancy and within-lek population dynamics. Our findings show that USDA Conservation Reserve Program Grasslands (CRP) play an outsized role in sustaining lesser prairie-chicken populations throughout the Kansas portion of the species' range. Consequently, lesser prairie-chicken population trends are likely to be closely linked to future CRP enrollment, and particularly to program allocation and rental rate decisions made in the upcoming Farm Bill.

We currently have a draft manuscript from the first part of this work under review at *Conservation Biology*. We also used this dataset to address two additional questions, with manuscripts forthcoming:

1. Developing novel methods for fitting density-dependence models with covariates in a Bayesian hierarchical framework. 

2. Assessing habitat connectivity for lesser prairie-chickens at multiple spatial scales using clustering analyses.
...
Harrison, A. L., C. Stenzel, A. Anderson, J. Howell, R. B. Lanctot, M. Aikens, J. Aldabe, **L. A. Berigan**, ... and M. B. Wunder (2025). The collective application of shorebird tracking data to conservation. Conservation Biology e70194. [PDF](files/Harrison_ConBio_2026.pdf)
